...
(function() {
  ...
  function P(m, s, q, v, y) {
      ...
      y = y || !1;
      v.push([m, s, q, y]);
      return m.addEventListener ? (m.addEventListener(s, q, y),
  ...
  function cb(m) {
      if (!db) {
          var s = !1
            , q = !1;
          "undefined" === typeof qa.Chart.creditHref ? (m.creditHref = ga("iuuqr;..b`ow`rkr/bnl."),
          m.creditText = ga("B`ow`rKR/bnl")) : (s = m.updateOption("creditText"),
  ...
  function Y(m, s, q, v, x) {
      ...
      m = {};
      this.theme && y(s) && y(v) ? m = y(xa[this.theme]) ? xa.light1 : xa[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[s]) && (null === v ? m = this.parent.themeOptions[s] : 0 < this.parent.themeOptions[s].length && (v = Math.min(this.parent.themeOptions[s].length - 1, v),
  ...
  var W = {}, v = !!document.createElement("canvas").getContext, qa = {
      ...
      en: {}
  }, x = v ? "Trebuchet MS, Helvetica, sans-serif" : "Arial", Ea = v ? "Impact, Charcoal, sans-serif" : "Arial", za = {
    ...
    , V = function(m, s, q) {
      ...
      for (P = S = X = R = C = 0; 0 < I.length; )
          ...
          "#" === s || "0" === s)
              ...
              "E" !== s[0] && "e" !== s[0] || "0" !== s[s.length - 1] || !/[eE][+-]*[0]+/.test(s) ? "," === s ? (X++,
              S = P,
              P = 0,
              0 < z.length && (q = x + q)) : q = 1 < s.length && ('"' === s[0] && '"' === s[s.length - 1] || "'" === s[0] && "'" === s[s.length - 1]) ? s.slice(1, s.length - 1) + q : s + q : (s = 0 > W ? s.replace("+", "").replace("-", "") : s.replace("-", ""),
      ...
      for (I = !1; 0 < F.length; )
          ...
          I = !0) : "0" === s && (x += "0",
          I = !0) : 1 < s.length && ('"' === s[0] && '"' === s[s.length - 1] || "'" === s[0] && "'" === s[s.length - 1]) ? x += s.slice(1, s.length - 1) : "E" !== s[0] && "e" !== s[0] || "0" !== s[s.length - 1] || !/[eE][+-]*[0]+/.test(s) ? x += s : (s = 0 > W ? s.replace("+", "").replace("-", "") : s.replace("-", ""),
      ...
      if ("undefined" !== typeof m || this.options._isPlaceholder)
          ...
          this.isOptionsInArray) {
              ...
              var s = this.parent.options[this.optionsName]
                , v = s.length;
              this.options._isPlaceholder || (Ca(s),
              v = s.indexOf(this.options));
              this.options = "undefined" === typeof m ? {} : m;
              s[v] = this.options
          } else
              this.options = "undefined" === typeof m ? {} : m,
              m = this.parent.options,
              this.optionsName ? s = this.optionsName : (s = this._defaultsKey) && 0 !== s.length ? (v = s.charAt(0).toLowerCase(),
  ...
  Y.prototype.updateOption = function(m) {
      var s = qa[this._defaultsKey]
        ...
        , F = this._index;
      this.theme && y(z) && y(F) ? v = y(xa[this.theme]) ? xa.light1 : xa[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[z]) && (null === F ? v = this.parent.themeOptions[z] : 0 < this.parent.themeOptions[z].length && (v = Math.min(this.parent.themeOptions[z].length - 1, F),
  ...
  ka.prototype._getLineWithWidth = function(m, v, q) {
      ...
      q > v && 1 < F.length && (F = F.substr(0, F.length - 1),
      q = this.ctx.measureText(F).width);
      v = !0;
  ...
  Ha.prototype.render = function() {
      if (this.text) {
          ...
          F = 0.5 * v.width - this.margin - 2) : "center" === this.horizontalAlign && (null === this.maxWidth && (this.maxWidth = v.width - 4),
          F = 0.5 * v.height - 4));
          var I;
          y(this.padding) || "number" !== typeof this.padding ? y(this.padding) || "object" !== typeof this.padding || (I = this.padding.top ? this.padding.top : this.padding.bottom ? this.padding.bottom : 0,
          I += this.padding.bottom ? this.padding.bottom : this.padding.top ? this.padding.top : 0,
          I *= 1.25) : I = 2.5 * this.padding;
          ...
          C = "top") : "bottom" === this.verticalAlign && (x = v.y2 - 2 - I.height,
          C = "bottom"),
          "left" === this.horizontalAlign ? q = v.x1 + 2 : "center" === this.horizontalAlign ? q = v.x1 + v.width / 2 - I.width / 2 : "right" === this.horizontalAlign && (q = v.x2 - 2 - I.width - R),
          S = this.horizontalAlign,
          this.width = I.width,
          this.height = I.height) : "center" === this.verticalAlign && ("left" === this.horizontalAlign ? (q = v.x1 + 2,
          x = v.y2 - 2 - (this.maxWidth / 2 - I.width / 2),
          z = -90,
          C = "left",
          this.width = I.height,
          this.height = I.width) : "right" === this.horizontalAlign ? (q = v.x2 - 2,
          x = v.y1 + 2 + (this.maxWidth / 2 - I.width / 2),
          z = 90,
          C = "right",
          this.width = I.height,
          this.height = I.width) : "center" === this.horizontalAlign && (x = m.y1 + (m.height / 2 - I.height / 2),
  ...
  var Ka = {
      ...
      formatNumber: function(m, v, q) {
          q = q || "en";
          if (Ja[q])
              return V(m, v || "#,##0.##", new Ia(q));
          throw "Unknown Culture Name";
      },
      formatDate: function(m, v, q) {
          q = q || "en";
          if (Ja[q])
              return Aa(m, v || "DD MMM YYYY", new Ia(q));
          throw "Unknown Culture Name";
      }
  };
  ...
  Ka.Chart = function() {
          ...
          if (a && f && b) {
              ...
              if (!e)
                  try {
                      ...
                      f = window.open(),
                      f.document.write("<div>Please right click on the image and save it to your device</div>"),
                      f.document.close()
                  }
          }
      }
      function q(a, f) {
          ...
          if (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) {
              ...
              v ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = ta(c, e),
      ...
      function I(a, f, b, c) {
          ...
          if (this.options.customBreaks && 0 < this.options.customBreaks.length) {
              for (a = 0; a < this.options.customBreaks.length; a++)
                  this.customBreaks.push(new ba(this.chart,"customBreaks",this.options.customBreaks[a],a,++this.chart._eventManager.lastObjectId,this)),
      ...
      q.prototype._updateOptions = function() {
          ...
          this._menuButton ? this.exportEnabled ? Ma(this._menuButton) : va(this._menuButton) : this.exportEnabled && v && (f = !1,
          ...
          P(this._menuButton, "mouseover", function() {
          ...
          P(this._menuButton, "mouseout", function() {
              f || (oa(a, a._menuButton, {
                  backgroundColor: a.toolbar.backgroundColor,
                  color: a.toolbar.fontColor
              }),
      ...
      q.prototype._updateSize = function() {
          ...
          return this.canvas.width !== a * ia || this.canvas.height !== f * ia ? (Ga(this.canvas, a, f),
      ...
      q.prototype.render = function(a) {
          ...
          bb(this);
          this._processData();
          this.options.title && (this.title = new Ha(this,this.options.title),
          ...
          for (a = 0; a < this._axes.length; a++)
              if (this._axes[a].scaleBreaks && this._axes[a].scaleBreaks._appliedBreaks.length) {
                  v ? (this._breaksCanvas = ta(this.width, this.height, !0),
          ...
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
              for (var f = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, g = !1, h = [], l = [], t = Infinity, k = -Infinity, r = 0; r < a.dataSeriesIndexes.length; r++) {
                  ...
                  if ("normal" === p.axisPlacement || "xySwapped" === p.axisPlacement)
                      var D = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity
                  ...
                  for (n = 0; n < p.dataPoints.length; n++) {
                      ...
                      if (c < D && !d)
                          ...
                          c < b.viewPortMin && (b.viewPortMin = c);
                          c > b.viewPortMax && (b.viewPortMax = c);
                          null === p.dataPoints[n].y ? b.viewPortMin === c && ya < c && (b.viewPortMin = ya) : (a.yTotals[c] = (a.yTotals[c] ? a.yTotals[c] : 0) + e,
                          0 <= e ? h[c] ? h[c] += e : (h[c] = e,
          ...
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
              for (var f = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, g, h, l = !1, t = 0; t < a.dataSeriesIndexes.length; t++) {
                  ...
                  if ("normal" === k.axisPlacement || "xySwapped" === k.axisPlacement)
                      var D = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : a.axisX.logarithmic ? 0 : -Infinity
                        , u = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ? this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity;
              ...
              for (h = 0; h < this._axes.length; h++)
                  if (this._axes[h].dataInfo._dataRanges) {
                      ...
                      for (l = 0; l < Math.min(g.length, this._axes[h].scaleBreaks.maxNumberOfAutoBreaks); l++)
                          ...
                          this._axes[h].scaleBreaks.autoBreaks.push(new ba(this,"autoBreaks",c,l,++this._eventManager.lastObjectId,this._axes[h].scaleBreaks)),
      ...
      q.prototype.getDataPointAtXY = function(a, f, b) {
          ...
          for (b = 0; b < c.length; b++)
              if ("line" === c[b].dataSeries.type || "stepLine" === c[b].dataSeries.type || "area" === c[b].dataSeries.type || "stepArea" === c[b].dataSeries.type)
                  if (e = ja("markerSize", c[b].dataPoint, c[b].dataSeries) || 8,
                  c[b].distance <= e / 2) {
                      f = !0;
                      break
                  }
          ...
          for (a = 0; a < this._indexLabels.length; a++) {
              ...
              if (null !== H && "" !== H) {
                  ...
                  if ("stackedarea100" === r) {
                      ...
                      if (k.dataPoint.x < s.viewportMinimum || k.dataPoint.x > s.viewportMaximum || k.bounds.x1 > b.x2 || k.bounds.x2 < b.x1)
                          continue
                  ...
                  if ("normal" === this.plotInfo.axisPlacement) {
                      ...
                      c = 0 <= r.indexOf("range") || "error" === r ? 0 < q ? Math.max(k.bounds.y1, b.y1) + t / 2 + h : Math.min(k.bounds.y2, b.y2) - t / 2 - h : (Math.max(k.bounds.y1, b.y1) + Math.min(k.bounds.y2, b.y2)) / 2,
                      0 < q ? (n = Math.max(k.point.y, c) - t / 2,
                      ...
                      c = 0 <= r.indexOf("range") || "error" === r ? 0 > q ? Math.max(k.bounds.x1, b.x1) + l / 2 + e : Math.min(k.bounds.x2, b.x2) - l / 2 - e : (Math.max(k.bounds.x1, b.x1) + Math.min(k.bounds.x2, b.x2)) / 2,
                  ...
                  0 <= r.indexOf("bar") || "error" === r && k.axisSwapped ? f.lineTo(p + (0 < k.direction ? 0 : l), n + ("horizontal" === Q ? t : -t) / 2) : 0 <= r.indexOf("column") || "error" === r && !k.axisSwapped ? f.lineTo(p + l / 2, n + ((0 < k.direction ? t : -t) + ("horizontal" === Q ? t : -t)) / 2) : f.lineTo(p + l / 2, n + ((n < k.point.y ? t : -t) + ("horizontal" === Q ? t : -t)) / 2),
                  f.stroke())
              }
          }
          f = {
                      ...
                      for (var q = !1, u = 0; u < r.length; u++)
                          ...
                          !(Q < a.axisX.dataInfo.viewPortMin || Q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !q)))
                              if ("number" !== typeof r[u].y)
                                  ...
                                  D || q ? (!D && k.connectNullData ? (b.setLineDash && (k.options.nullDataLineDashType || p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (b.stroke(),
                                  b.beginPath(),
                                  b.moveTo(h.x, h.y),
                                  p = k.nullDataLineDashType,
                                  b.setLineDash(n)),
                                  b.lineTo(Q, H),
                                  v && c.lineTo(Q, H)) : (b.beginPath(),
                                  b.moveTo(Q, H),
                                  v && (c.beginPath(),
                                  c.moveTo(Q, H))),
                                  q = D = !1) : (b.lineTo(Q, H),
                                  ...
                                  b.setLineDash(F(p, k.lineThickness))) : (p = k.lineDashType,
                                  b.setLineDash(d))));
      ...
      q.prototype.renderStepLine = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              for (var g = [], h, l = 0; l < a.dataSeriesIndexes.length; l++) {
                  ...
                  if (0 < r.length) {
                      for (var q = !1, u = 0; u < r.length; u++)
                          if (Q = r[u].getTime ? r[u].x.getTime() : r[u].x,
                          !(Q < a.axisX.dataInfo.viewPortMin || Q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !q)))
                              if ("number" !== typeof r[u].y)
                                  0 < u && !(k.connectNullData || q || D) && (b.stroke(),
                                  v && c.stroke()),
                      ...
                      D = 0; D < r.length; D++)
                          ...
                          !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !Q)))
                              if ("number" !== typeof r[D].y)
                                  0 < D && !Q && (k.connectNullData ? c.setLineDash && (0 < H.length && (k.options.nullDataLineDashType || !r[D - 1].lineDashType)) && (H[H.length - 1].newLineDashArray = n,
                                  p = k.nullDataLineDashType) : (f(H),
                                  H = [])),
                                  Q = !0;
                              else {
                                  ...
                                  H[H.length - 1].newLineDashArray = F(p, k.lineThickness)) : (p = k.lineDashType,
      ...
      q.prototype.renderColumn = function(a) {
          var f = a.targetCanvasCtx || this.plotArea.ctx
            , b = v ? this._preRenderCtx : f;
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var c = null, e = this.plotArea, g = 0, h, l, t, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), g = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, r = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.width, 0.9 * (this.plotArea.width / a.plotType.totalDataSeries)) << 0, p = a.axisX.dataInfo.minDiff;
      ...
      q.prototype.renderStackedColumn = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              this.dataPointMaxWidth && k > r && (k = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, r));
              ...
              for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                  ...
                  if (0 < m.length) {
                      ...
                      for (var ca = !0; D < m.length; D++)
                          ...
                          !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!w.connectNullData || !ca)))
                              if ("number" !== typeof m[D].y)
                                  w.connectNullData || (ca || f) || c(),
                                  ca = !0;
                              else {
                                  u = a.axisX.convertValueToPixel(q);
                                  s = a.axisY.convertValueToPixel(m[D].y);
                                  f || ca ? (!f && w.connectNullData ? (g.setLineDash && (w.options.nullDataLineDashType || b === w.lineDashType && w.lineDashType !== w.nullDataLineDashType) && (f = u,
                                  b = s,
                                  u = p.x,
                                  s = p.y,
                                  c(),
                                  ...
                                  D < m.length - 1 && (L !== (m[D].lineColor || z) || b !== (m[D].lineDashType || w.lineDashType)) && (c(),
                                  L = m[D].lineColor || z,
                                  g.strokeStyle = L,
                                  g.setLineDash && (m[D].lineDashType ? (b = m[D].lineDashType,
                                  g.setLineDash(F(b, w.lineThickness))) : (b = w.lineDashType,
                                  g.setLineDash(da))));
                      ...
                      for (m = !1; d < n.length; d++)
                          ...
                          !(w < a.axisX.dataInfo.viewPortMin || w > a.axisX.dataInfo.viewPortMax && (!p.connectNullData || !m)))
                              if ("number" !== typeof n[d].y)
                                  0 < d && !m && (p.connectNullData ? c.setLineDash && (0 < q.length && (p.options.nullDataLineDashType || !n[d - 1].lineDashType)) && (q[q.length - 1].newLineDashArray = la,
                                  ...
                                  q[q.length - 1].newLineDashArray = F(z, p.lineThickness)) : (z = p.lineDashType,
                  ...
                  if (0 < m.length) {
                      ...
                      for (; D < m.length; D++)
                          ...
                          !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!w.connectNullData || !b))) {
                              ...
                              s = a.axisY.convertValueToPixel(m[D].y),
                              f || b ? (!f && w.connectNullData ? (g.setLineDash && (w.options.nullDataLineDashType || K === w.lineDashType && w.lineDashType !== w.nullDataLineDashType) && (f = u,
                              b = s,
                              u = p.x,
                              s = p.y,
                              c(),
                              ...
                              D < m.length - 1 && (L !== (m[D].lineColor || z) || K !== (m[D].lineDashType || w.lineDashType)) && (c(),
                              L = m[D].lineColor || z,
                              g.strokeStyle = L,
                              g.setLineDash && (m[D].lineDashType ? (K = m[D].lineDashType,
                              g.setLineDash(F(K, w.lineThickness))) : (K = w.lineDashType,
                              g.setLineDash(ca)))),
                              q = w.dataPointIds[D],
                              ...
                              0 !== m[D].markerSize && (0 < m[D].markerSize || 0 < w.markerSize) && (aa = w.getMarkerProperties(D, u, s, g),
                              k.push(aa),
                              q = R(q),
                              v && k.push({
                                  x: u,
                          ...
                          if (!(w < a.axisX.dataInfo.viewPortMin || w > a.axisX.dataInfo.viewPortMax && (!A.connectNullData || !ca)))
                              if ("number" !== typeof aa.y)
                                  ...
                                  if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) {
                                      ...
                                      d = a.axisY.convertValueToPixel(aa.y),
                                      d -= wa;
                                  t.push({
                                      x: n,
                                      y: m - wa
                                  ...
                                  l[w] = m - d;
                                  s || ca ? (!s && A.connectNullData ? (c.setLineDash && (A.options.nullDataLineDashType || q === A.lineDashType && A.lineDashType !== A.nullDataLineDashType) && (s = t.pop(),
                                  q = t[t.length - 1],
                                  f(),
                                  c.moveTo(u.x, u.y),
                                  t.push(q),
                                  ...
                                  p < x.length - 1 && (L !== (x[p].lineColor || z) || q !== (x[p].lineDashType || A.lineDashType)) && (f(),
                                  c.beginPath(),
                                  c.moveTo(n, d),
                                  t.push({
                                      x: n,
                                  ...
                                  L = x[p].lineColor || z,
                                  c.strokeStyle = L,
                                  c.setLineDash && (x[p].lineDashType ? (q = x[p].lineDashType,
                                  c.setLineDash(F(q, A.lineThickness))) : (q = A.lineDashType,
                                  c.setLineDash(da))));
                                  ...
                                  0 <= A.dataPointIndexes[w] && 0 !== aa.markerSize && (0 < aa.markerSize || 0 < A.markerSize) && (w = A.getMarkerProperties(A.dataPointIndexes[w], n, d, c),
                                  g.push(w),
                                  markerColor = R(ma),
                                  v && g.push({
                                      x: n,
                          ...
                          if (!(w < a.axisX.dataInfo.viewPortMin || w > a.axisX.dataInfo.viewPortMax && (!A.connectNullData || !ca)))
                              if ("number" !== typeof aa.y)
                                  ...
                                  if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) {
                                      ...
                                      d = a.axisY.convertValueToPixel(wa),
                                      d -= ma;
                                  t.push({
                                      x: n,
                                      y: q - ma
                                  ...
                                  l[w] = q - d;
                                  s || ca ? (!s && A.connectNullData ? (c.setLineDash && (A.options.nullDataLineDashType || u === A.lineDashType && A.lineDashType !== A.nullDataLineDashType) && (s = t.pop(),
                                  u = t[t.length - 1],
                                  f(),
                                  c.moveTo(m.x, m.y),
                                  t.push(u),
                                  ...
                                  p < z.length - 1 && (L !== (z[p].lineColor || C) || u !== (z[p].lineDashType || A.lineDashType)) && (f(),
                                  c.beginPath(),
                                  c.moveTo(n, d),
                                  t.push({
                                      x: n,
                                  ...
                                  c.setLineDash(F(u, A.lineThickness))) : (u = A.lineDashType,
                                  c.setLineDash(da))));
                                  if (0 <= A.dataPointIndexes[w]) {
                                  ...
                                  0 <= A.dataPointIndexes[w] && 0 !== aa.markerSize && (0 < aa.markerSize || 0 < A.markerSize) && (w = A.getMarkerProperties(p, n, d, c),
                                  h.push(w),
                                  markerColor = R(E),
                                  v && h.push({
                                      x: n,
      ...
      q.prototype.renderCandlestick = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = null, g = null, h = this.plotArea, l = 0, t, k, r, p, n, d, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, g = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.015 * this.width, w = a.axisX.dataInfo.minDiff;
                  ...
                  if (0 < q.length)
                      for (var H = 5 < w && u.bevelEnabled ? !0 : !1, l = 0; l < q.length; l++)
                          ...
                          !(d < a.axisX.dataInfo.viewPortMin || d > a.axisX.dataInfo.viewPortMax) && !y(q[l].y) && q[l].y.length && "number" === typeof q[l].y[0] && "number" === typeof q[l].y[1] && "number" === typeof q[l].y[2] && "number" === typeof q[l].y[3]) {
                              ...
                              b.lineTo(t - z, p),
                              b.stroke(),
                              X(b, x, Math.min(k, n), B, Math.max(k, n), q[l].y[0] <= q[l].y[3] ? u.risingColor : g, A, e, H, H, !1, !1, u.fillOpacity),
                              v && (e = R(C),
                              c.strokeStyle = e,
                              c.moveTo(t - z, r),
                              ...
                              c.lineTo(t - z, p),
                              c.stroke(),
                              X(c, x, Math.min(k, n), B, Math.max(k, n), e, 0, null, !1, !1, !1, !1))) : "ohlc" === u.type && (b.moveTo(t - z, r),
                              b.lineTo(t - z, p),
                              b.stroke(),
                              b.beginPath(),
                              b.moveTo(t, k),
              ...
              for (var m = !1, m = !!a.axisY.reversed, s = 0; s < a.dataSeriesIndexes.length; s++) {
                  ...
                  if (0 < H.length)
                      for (var x = 5 < w && q.bevelEnabled ? !0 : !1, h = 0; h < H.length; h++)
                          if (H[h].getTime ? d = H[h].x.getTime() : d = H[h].x,
                          !(d < a.axisX.dataInfo.viewPortMin || d > a.axisX.dataInfo.viewPortMax) && !y(H[h].y) && H[h].y.length && "number" === typeof H[h].y[0] && "number" === typeof H[h].y[1] && "number" === typeof H[h].y[2] && "number" === typeof H[h].y[3] && "number" === typeof H[h].y[4] && 5 === H[h].y.length) {
      ...
      q.prototype.renderRangeColumn = function(a) {
          var f = a.targetCanvasCtx || this.plotArea.ctx
            , b = v ? this._preRenderCtx : f;
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var c = null, e = this.plotArea, g = 0, h, l, t, g = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
      ...
      q.prototype.renderError = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              for (var s = 0; s < a.dataSeriesIndexes.length; s++) {
                  ...
                  g && (l = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : c ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (A ? q : 1))) << 0 : 0.03 * this.width);
                      ...
                      for (var L = !0; d < p.length; d++)
                          ...
                          !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!r.connectNullData || !L)))
                              if (null !== p[d].y && p[d].y.length && "number" === typeof p[d].y[0] && "number" === typeof p[d].y[1]) {
                                  ...
                                  n || L ? (r.connectNullData && !n ? (c.setLineDash && (r.options.nullDataLineDashType || A === r.lineDashType && r.lineDashType !== r.nullDataLineDashType) && (t[t.length - 1].newLineDashArray = C,
                      ...
                      for (d = !1; p < r.length; p++)
                          ...
                          !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !d)))
                              if (null !== r[p].y && r[p].y.length && "number" === typeof r[p].y[0] && "number" === typeof r[p].y[1]) {
                                  ...
                                  m[m.length - 1].newLineDashArray = F(z, k.lineThickness)) : (z = k.lineDashType,
                  ...
                  if (0 < q.length)
                      for (var y = 5 < n && m.bevelEnabled ? !0 : !1, x = !1, z = null, A = null, h = 0; h < q.length; h++)
                          ...
                          "number" !== typeof q[h].y) {
                              ...
                              0 < h && z && (!x || m.connectNullData) && (x && b.setLineDash && b.setLineDash(F(C, u)),
                              b.beginPath(),
                              b.moveTo(z, A - s),
                              b.lineTo(L, K - s),
                              0 < u && b.stroke(),
              ...
              for (var b = a = 0, f = 0, h = !0, b = 0; 10 > b && (1 > b || 0 < f); b++) {
                      ...
                      for (var u, y, a = 0; a < r.length; a++) {
                          ...
                          if (null !== z) {
                              ...
                              if (0 > B) {
                                  ...
                                  var F = -1 * (B - y)
                                    , J = sa = 0;
                                  "right" === l.hemisphere ? (sa = g(a, y),
                                  F = -1 * (B - sa),
                                  J = g(z, F),
                                  +J.toFixed(v) < +F.toFixed(v) && +sa.toFixed(v) <= +y.toFixed(v) && g(a, -(F - J))) : (sa = g(z, y),
                                  F = -1 * (B - sa),
                                  J = g(a, F),
                  ...
                  for (a = 0; a < r.length; a++)
                      ...
                      0 !== z.height && 0 !== z.width)
                          z = z = 0,
                          "right" === l.hemisphere ? (z = n.x2 - (l.indexLabelTextBlock.x + l.indexLabelTextBlock.width + p),
                          z *= -1) : z = n.x1 - (l.indexLabelTextBlock.x - l.indexLabelTextBlock.width - p),
                          0 < z && (!h && l.indexLabelText && (y = "right" === l.hemisphere ? n.x2 - l.indexLabelTextBlock.x : l.indexLabelTextBlock.x - n.x1,
                          ...
                          Math.abs(l.indexLabelTextBlock.y - l.indexLabelTextBlock.height / 2 - x.y) < A || Math.abs(l.indexLabelTextBlock.y + l.indexLabelTextBlock.height / 2 - x.y) < A) && (z /= Math.abs(Math.cos(l.indexLabelAngle)),
                          9 < z && (z *= 0.3),
                          z > f && (f = z)),
                          z = z = 0,
                          0 < l.indexLabelAngle && l.indexLabelAngle < Math.PI ? (z = n.y2 - (l.indexLabelTextBlock.y + l.indexLabelTextBlock.height / 2 + 5),
                          z *= -1) : z = n.y1 - (l.indexLabelTextBlock.y - l.indexLabelTextBlock.height / 2 - 5),
                          0 < z && (!h && l.indexLabelText && (y = 0 < l.indexLabelAngle && l.indexLabelAngle < Math.PI ? -1 : 1,
                          0 === g(a, z * y) && g(a, 2 * y)),
                          Math.abs(l.indexLabelTextBlock.x - x.x) < A && (z /= Math.abs(Math.sin(l.indexLabelAngle)),
                          9 < z && (z *= 0.3),
                          z > f && (f = z)));
      ...
      q.prototype.renderFunnel = function(a) {
          ...
          function b() {
              ...
              for (var k = d[0] = 0, l = 0, n, b = b - a, t = !1, h = 0; h < x.length; h++)
                  ...
                  t ? k = 0 == Number(c.toFixed(3)) ? 0 : a / c : (sqrt = ea * ea * b * b - 4 * Math.abs(ea) * a,
                  0 > sqrt ? (n = c,
                  k = (b + n) * (e - l) / 2,
                  a -= k,
                  k = e - l,
                  ...
                  k += 0 == n ? 0 : a / n,
                  l += a / n,
                  t = !0) : (k = (Math.abs(ea) * b - Math.sqrt(sqrt)) / 2,
                  n = b - 2 * k / Math.abs(ea),
                  l += k,
                  l > e && (l -= k,
                  n = c,
          ...
          function c() {
              if (u && x) {
                  for (var a, b, c, e, f, g, h, k, l, n, t, p, r, m, w = [], q = [], z = {
                      percent: null,
                      total: null
                  }, A = null, B = 0; B < x.length; B++)
                      m = N[B],
                      m = "undefined" !== typeof m.x5 ? (m.y2 + m.y4) / 2 : (m.y2 + m.y3) / 2,
                      m = d(m).x2 + 1,
                      w[B] = S - m - U;
                  m = 0.5 * U;
                  for (var B = 0, ya = x.length - 1; B < x.length || 0 <= ya; B++,
                  ya--) {
                      ...
                      "inside" === u.indexLabelPlacement && (w[B] = B !== fa ? u.reversed ? N[B].x2 - N[B].x1 : N[B].x3 - N[B].x4 : N[B].x3 - N[B].x6,
                      20 > w[B] && (w[B] = B !== fa ? u.reversed ? N[B].x3 - N[B].x4 : N[B].x2 - N[B].x1 : N[B].x2 - N[B].x1,
                      w[B] /= 2));
                      ...
                      b = b.indexLabelFormatter ? b.indexLabelFormatter(A) : b.indexLabel ? s.replaceKeywordsWithValue(b.indexLabel, b, u, B) : u.indexLabelFormatter ? u.indexLabelFormatter(A) : u.indexLabel ? s.replaceKeywordsWithValue(u.indexLabel, b, u, B) : b.label ? b.label : "";
                      0 >= n && (n = 0);
          ...
          function e() {
              ...
              if (e)
                  for (h = G.length - 1; 0 <= h; h--)
                      ...
                      u.reversed ? (G[h].textBlock.y + G[h].height > T + C && (G[h].textBlock.y = T + C - G[h].height),
                      G[h].textBlock.y < ra - C && (G[h].textBlock.y = ra - C)) : (G[h].textBlock.y < T - C && (G[h].textBlock.y = T - C),
          ...
          function g() {
              ...
              if ("inside" !== u.indexLabelPlacement)
                  for (var f = 0; f < N.length; f++)
                      0 == G[f].textBlock.text.length ? G[f].isDirty = !0 : (a = N[f],
                      c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2,
                      b = u.reversed ? "undefined" !== typeof a.x5 ? c > ba ? d(c).x2 + 1 : (a.x2 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1 : "undefined" !== typeof a.x5 ? c < ba ? d(c).x2 + 1 : (a.x4 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1,
                      G[f].textBlock.x = b + U,
                      G[f].textBlock.y = c - G[f].height / 2,
                      u.reversed ? (G[f].textBlock.y + G[f].height > T + C && (G[f].textBlock.y = T + C - G[f].height),
                      G[f].textBlock.y < ra - C && (G[f].textBlock.y = ra - C)) : (G[f].textBlock.y < T - C && (G[f].textBlock.y = T - C),
                  ...
                  for (f = 0; f < N.length; f++)
                      ...
                      c = G[f].height,
                      e = G[f].width,
                      b >= c ? (b = f != fa ? (a.x4 + a.x3) / 2 - e / 2 : (a.x5 + a.x4) / 2 - e / 2,
                      c = f != fa ? (a.y1 + a.y3) / 2 - c / 2 : (a.y1 + a.y4) / 2 - c / 2,
                      G[f].textBlock.x = b,
                      G[f].textBlock.y = c) : G[f].isDirty = !0)
          }
          function h() {
              function a(b, c) {
                  var d;
              ...
              function b() {
                  ...
                  for (var k, l = 1; l < h; l++) {
                      ...
                      for (var r = G.length - 1; 0 <= r; r--)
                          !G[r].isDirty && (G[r].textBlock.y < e && G[r].textBlock.y + G[r].height > e) && (k = n(r),
                          !(k >= G.length - 1) && G[r].textBlock.y + G[r].height + ga > G[k].textBlock.y && (G[r].textBlock.y = G[r].textBlock.y + G[r].height - e > e - G[r].textBlock.y ? e + 1 : e - G[r].height - 1))
                  }
              ...
              for (var d, e, f, g, h, k, t = 1, r = 0; r < 2 * t; r++) {
                  for (var m = G.length - 1; 0 <= m && !(previousTextBlock = (previousLabel = 0 <= p(m) ? G[p(m)] : null) ? previousLabel.textBlock : null,
                  f = G[m],
                  g = f.textBlock,
                  k = (h = n(m) < N.length ? G[n(m)] : null) ? h.textBlock : null,
                  d = +f.height.toFixed(6),
                  e = +g.y.toFixed(6),
                  !f.isDirty && (h && e + d + ga > +k.y.toFixed(6)) && (d = g.y + d + ga - k.y,
                  e = a(m, -d),
                  e < d && (0 < e && (d -= e),
                  e = a(n(m), d),
                  e != d))); m--)
          ...
          function t(a, b, c) {
              ...
              a._animator.animate(0, c, function(c) {
                  ...
                  q(d);
                  L && ("inside" !== u.indexLabelPlacement ? r(d) : g(),
                  m(d));
                  1 <= c && (ia = !1)
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              for (var u = this.data[a.dataSeriesIndexes[0]], x = u.dataPoints, z = this.plotArea, C = 0.025 * z.width, B = 0.01 * z.width, A = 0, J = z.height - 2 * C, I = Math.min(z.width - 2 * B, 2.8 * z.height), L = !1, K = 0; K < x.length; K++)
                  if (!L && ("undefined" !== typeof x[K].indexLabel && null !== x[K].indexLabel && 0 < x[K].indexLabel.toString().length) && (L = !0),
                  !L && ("undefined" !== typeof x[K].label && null !== x[K].label && 0 < x[K].label.toString().length) && (L = !0),
              ...
              if (0 != u.length && (u.dataPoints && u.visible) && 0 !== x.length) {
                  ...
                  a = 75 * I / 100;
                  var U = 30 * (S - a) / 100;
                  "funnel" === u.type ? (P = y(u.options.neckHeight) ? 0.35 * J : u.neckHeight,
                  E = y(u.options.neckWidth) ? 0.25 * a : u.neckWidth,
                  "string" === typeof P && P.match(/%$/) ? (P = parseInt(P),
                  P = P * J / 100) : P = parseInt(P),
                  "string" === typeof E && E.match(/%$/) ? (E = parseInt(E),
                  E = E * a / 100) : E = parseInt(E),
                  P > J ? P = J : 0 >= P && (P = 0),
                  E > a ? E = a - 0.5 : 0 >= E && (E = 0)) : "pyramid" === u.type && (E = P = 0,
                  ...
                  if (-1 !== K) {
                      ...
                      if (u.reversed)
                          for (E = 0; E < K.length; E++)
                              I[E] < ba ? (a.push(M),
                              B.push(Z),
                              fa = E) : (a.push((I[E] - T + ea * Y) / ea),
                              B.push((I[E] - T + ha * X) / ha));
                      else
                          for (E = 0; E < K.length; E++)
                              I[E] < ba ? (a.push((I[E] - T + ea * Y) / ea),
                              B.push((I[E] - T + ha * X) / ha),
                              fa = E) : (a.push(M),
                              B.push(Z));
                      for (E = 0; E < K.length - 1; E++)
                          V = u.reversed ? x[x.length - 1 - E].color ? x[x.length - 1 - E].color : u._colorSet[(x.length - 1 - E) % u._colorSet.length] : x[E].color ? x[E].color : u._colorSet[E % u._colorSet.length],
                          E === fa ? N.push({
                              x1: a[E],
                              y1: I[E],
                              x2: B[E],
                      ...
                      for (E = 0; E < x.length; E++)
                          x[E].exploded && (K = !0,
                          u.reversed ? $.push(x.length - 1 - E) : $.push(E));
                      ...
                      "inside" !== u.indexLabelPlacement)) {
                          h();
                          for (E = 0; E < x.length; E++)
                              G[E].isDirty || (a = G[E].textBlock.x + G[E].width,
                              a = (S - a) / 2,
                              0 == E && (A = a),
                              A > a && (A = a));
                          for (E = 0; E < N.length; E++)
                      ...
                      for (E = 0; E < N.length; E++)
                          A = N[E],
                          qa(R, A, u.fillOpacity),
                          ja.push(A.y1);
                      q(R);
                      L && u.visible && ("inside" === u.indexLabelPlacement || s.animationEnabled || r(R),
                      ...
                      this.funnelPyramidClickHandler = function(a) {
                          var b = -1;
                          if (!ia && !s.isAnimating && (y(a.dataSeries.explodeOnClick) || a.dataSeries.explodeOnClick) && (b = u.reversed ? x.length - 1 - a.dataPointIndex : a.dataPointIndex,
                          0 <= b)) {
                              a = b;
      ...
      q.prototype.replaceKeywordsWithValue = function(a, f, b, c, e) {
          ...
          return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
              ...
              try {
                  var d = a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);
                  d && 0 < d.length && (h = Fa(d[2]),
                  a = Fa(d[1]))
              } catch (k) {}
              d = null;
              if ("color" === a)
                  return "waterfall" === b.type ? f.color ? f.color : 0 < f.y ? b.risingColor : b.fallingColor : "error" === b.type ? b.color ? b.color : b._colorSet[h % b._colorSet.length] : f.color ? f.color : b.color ? b.color : b._colorSet[c % b._colorSet.length];
              ...
              if ("x" === a)
                  if ("dateTime" === b.axisX.valueType || "dateTime" === b.xValueType || f.x && f.x.getTime) {
                      if (g.plotInfo.plotTypes[0].plotUnits[0].axisX && !g.plotInfo.plotTypes[0].plotUnits[0].axisX.logarithmic)
                          return Aa(d, f.xValueFormatString ? f.xValueFormatString : b.xValueFormatString ? b.xValueFormatString : b.xValueFormatString = g.axisX && g.axisX.autoValueFormatString ? g.axisX.autoValueFormatString : "DD MMM YY", g._cultureInfo)
                  } else
                  ...
                  return "y" === a ? V(d, f.yValueFormatString ? f.yValueFormatString : b.yValueFormatString ? b.yValueFormatString : b.yValueFormatString = "#,##0.########", g._cultureInfo) : "z" === a ? V(d, f.zValueFormatString ? f.zValueFormatString : b.zValueFormatString ? b.zValueFormatString : b.zValueFormatString = "#,##0.########", g._cultureInfo) : d
          })
      }
      ;
      na(T, Y);
      T.prototype.render = function() {
          ...
          for (p = f = 0; p < k.length; p++) {
              ...
              for (z = x = 0; z < n.items.length; z++) {
                  ...
                  $.drawMarker(q + s / 2, u + this.lineHeight / 2, this.ctx, d.markerType, "error" === d.chartType || "line" === d.chartType || "spline" === d.chartType ? d.markerSize / 2 : d.markerSize, d.markerColor, d.markerBorderColor, d.markerBorderThickness);
                  d.textBlock.x = q + l + s;
                  if ("line" === d.chartType || "stepLine" === d.chartType || "spline" === d.chartType)
      ...
      C.prototype.createLabelsAndCalculateHeight = function() {
          ...
          if ("bottom" === this._position || "top" === this._position) {
              ...
              for (b = 0; b < this._stripLineLabels.length; b++)
                  "outside" === this._stripLineLabels[b].stripLine.labelPlacement && (this._stripLineLabels[b].stripLine.value >= this.viewportMinimum && this._stripLineLabels[b].stripLine.value <= this.viewportMaximum) && (f = this._stripLineLabels[b].textBlock,
                  c = f.measureText(),
                  e = 0 === this.labelAngle ? c.height : c.width * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)) + (c.height - f.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)),
                  a < e && (a = e),
              ...
              for (var z = [], C = [], F = [], B = [], P = [], R = [], S = [], T = []; 4 > s; ) {
                  ...
                  if (a && 0 < a.length)
                      for (d = 0; d < a.length; d++)
                          ...
                          a[d] && (a[d].labelAutoFit && !y(A) && !y(I)) && (l = 0,
                          0 < a[d].labelAngle ? I + u > t && (l += 0 < a[d].labelAngle ? I + u - t - ba : 0) : 0 > a[d].labelAngle ? A - x < h && A - x < a[d].viewportMinimum && (J = h - (M + a[d].tickLength + F + A - x + a[d].labelFontSize / 2)) : 0 === a[d].labelAngle && (I + u > t && (l = I + u / 2 - t - ba),
                          A - x < h && A - x < a[d].viewportMinimum && (J = h - M - a[d].tickLength - F - A + x / 2)),
                          a[d].viewportMaximum === a[d].maximum && a[d].viewportMinimum === a[d].minimum && 0 < a[d].labelAngle && 0 < l ? t -= l : a[d].viewportMaximum === a[d].maximum && a[d].viewportMinimum === a[d].minimum && 0 > a[d].labelAngle && 0 < J ? h += J : a[d].viewportMaximum === a[d].maximum && a[d].viewportMinimum === a[d].minimum && 0 === a[d].labelAngle && (0 < J && (h += J),
                          0 < l && (t -= l))),
                  ...
                  if (a && 0 < a.length)
                      for (d = 0; d < a.length; d++)
                          ...
                          I = a[d].logarithmic ? (1 < h ? Math.log(h) / a[d].conversionParameters.lnLogarithmBase * Math.abs(a[d].conversionParameters.pixelPerUnit) : 0) + a[d].lineCoordinates.x1 : (0 < h ? h * Math.abs(a[d].conversionParameters.pixelPerUnit) : 0) + a[d].lineCoordinates.x1));
                  if (f && 0 < f.length)
                      for (d = 0; d < f.length; d++)
                          ...
                          I = f[d].logarithmic ? (1 < h ? Math.log(h) / f[d].conversionParameters.lnLogarithmBase * Math.abs(f[d].conversionParameters.pixelPerUnit) : 0) + f[d].lineCoordinates.x1 : (0 < h ? h * Math.abs(f[d].conversionParameters.pixelPerUnit) : 0) + f[d].lineCoordinates.x1);
                  for (d = 0; d < n.length; d++)
              ...
              for (S = []; 4 > s; ) {
                  ...
                  if (c && 0 < c.length)
                      for (d = 0; d < c.length; d++)
                          ...
                          c[d] && c[d].labelAutoFit && !y(F) && (0 < !a.length && (h = 0 < c[d].labelAngle ? Math.max(h, F) : 0 === c[d].labelAngle ? Math.max(h, F / 2) : h),
                          0 < !f.length && (t -= B / 2)),
                  ...
                  if (c && 0 < c.length)
                      for (d = 0; d < c.length; d++)
                          ...
                          F = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)),
                      ...
                      for (d = 0; d < a.length; d++) {
                          ...
                          if (b && 0 < b.length)
                              for (M = 0; M < b.length; M++)
                                  b[M] && b[M].labelAutoFit && (t = 0 > b[M].labelAngle ? Math.max(t, z) : 0 === b[M].labelAngle ? Math.max(t, z / 2) : t,
                                  h = 0 > b[M].labelAngle || 0 === b[M].labelAngle ? t - Z : h);
                          if (c && 0 < c.length)
                              for (M = 0; M < c.length; M++)
                                  c[M] && c[M].labelAutoFit && (t = c[M].lineCoordinates.x1,
                                  h = t - Z);
                          a[d].lineCoordinates = {
                              x1: t - T,
                              y1: l,
                  ...
                  if (f && 0 < f.length)
                      for (d = 0; d < f.length; d++) {
                          ...
                          if (c && 0 < c.length)
                              for (M = 0; M < c.length; M++)
                                  c[M] && c[M].labelAutoFit && (t = c[M].lineCoordinates.x2,
                                  h = t - V);
                          f[d].lineCoordinates = {
                              x1: t + Y,
                              y1: l,
      ...
      C.prototype.renderLabelsTicksAndTitle = function() {
          ...
          if ("inside" === this.labelPlacement)
              this.chart.addEventListener("dataAnimationIterationEnd", function() {
                  for (k = 0; k < a._labels.length; k++)
                      p = a._labels[k],
                      p.position < a.viewportMinimum || (p.position > a.viewportMaximum || f && 0 !== g++ % 2 && a.labelAutoFit) || (a.ctx.save(),
                      a.ctx.beginPath(),
              ...
              for (k = 0; k < this._labels.length; k++)
                  p = this._labels[k],
                  p.position < this.viewportMinimum || (p.position > this.viewportMaximum || f && 0 !== g++ % 2 && this.labelAutoFit) || p.textBlock.render(!0)
      }
      ;
      ...
      C.prototype.createMask = function() {
          if (this.scaleBreaks && 0 < this.scaleBreaks._appliedBreaks.length) {
              ...
              v ? (this.maskCanvas = ta(this.chart.width, this.chart.height),
          ...
          if (this.snapToDataPoint) {
              ...
              if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                  ...
                  if ("rangeColumn" === this.parent.dataSeries[q].type || "rangeArea" === this.parent.dataSeries[q].type || "error" === this.parent.dataSeries[q].type || "rangeSplineArea" === this.parent.dataSeries[q].type || "candlestick" === this.parent.dataSeries[q].type || "ohlc" === this.parent.dataSeries[q].type || "boxAndWhisker" === this.parent.dataSeries[q].type) {
                      ...
                      }) : y(this.options.label) ? V(m.dataSeries.dataPointEOs[m.index].cumulativeSum, this.valueFormatString, this.chart._cultureInfo) : this.label) : (h = 1 === r.lineWidth % 2 ? (this.parent.convertValueToPixel(m.dataPoint.y) << 0) + 0.5 : this.parent.convertValueToPixel(m.dataPoint.y) << 0,
                      l.text = this.labelFormatter ? this.labelFormatter({
                          chart: this.chart,
                          axis: this.parent.options,
                          crosshair: this.options,
              ...
              if ("xySwapped" === this.chart.plotInfo.axisPlacement)
                  ...
                  if (u) {
                      ...
                      "dateTime" === this.parent.valueType ? l.text = this.labelFormatter ? this.labelFormatter({
                          ...
                          crosshair: this.options,
                          value: this.parent.convertPixelToValue(a)
                      }) : y(this.options.label) ? Aa(this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (l.text = this.labelFormatter ? this.labelFormatter({
                          chart: this.chart,
                          axis: this.parent.options,
                          crosshair: this.options,
      ...
      Z.prototype.highlightObjects = function(a) {
          ...
          for (b = 0; b < a.length; b++) {
              ...
              if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
                  ...
                  f.stroke()),
                  f.beginPath(),
                  X(f, e.x1 - e.borderThickness / 2, Math.max(e.y2 + e.borderThickness / 2, e.y3 + e.borderThickness / 2), e.x2 + e.borderThickness / 2, Math.min(e.y2 - e.borderThickness / 2, e.y3 - e.borderThickness / 2), "transparent", e.borderThickness, e.color, !1, !1, !1, !1),
                  f.globalAlpha = 1,
